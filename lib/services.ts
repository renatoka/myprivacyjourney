...
export const OLD_PRIMARY_SERVICES: Service[] = [
  ...
  },
  {
    ...
    facts: {
      ...
      applications: 'Rich text, spreadsheets, presentations, forms, Kanban',
    },
    // euCompliance: 'compliant',
    pricing: {
      free: true,
...
export const OLD_ALTERNATIVE_SERVICES: Service[] = [
  ...
  },
  {
    ...
    cons: ['Less user-friendly than Signal', 'Smaller user base', 'More complex for average users'],
  },
  {
    id: 'bitwarden',
    name: 'Bitwarden',
...
export const ALL_SERVICES: Service[] = [...PRIMARY_SERVICES, ...ALTERNATIVE_SERVICES];
